...
if (-not (Test-Path "$javafxSdkPath")) {
    ...
    Write-Host "Extract the ZIP and place the contents in ..\openjfx-sdk\17.0.11 so that lib/ contains the JARs and DLLs." -ForegroundColor Yellow
    exit 1
}
...
$jpackageArgs = @(
    ...
    "--win-dir-chooser",
    "--win-shortcut-prompt",
    "--win-upgrade-uuid", "40758050-a628-41e2-95bf-4d3dc0448056"
)
